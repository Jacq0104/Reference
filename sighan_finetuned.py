...
# 模型存放的位置。
model_path = './drive/MyDrive/models/MDCSpell-finetuned/'
...
class CSCDataset(Dataset):
    ...
    def __init__(self):
        ...
        with open("sighan13_training_set_traditional.pkl", mode='br') as f:
            train_data = pickle.load(f)
        with open("sighan14_training_set_traditional.pkl", mode='br') as f:
            train_data.extend(pickle.load(f))
        with open("sighan15_training_set_traditional.pkl", mode='br') as f:
            train_data.extend(pickle.load(f))
...
pretrained_model_path = './drive/MyDrive/models/MDCSpell/MDCSpell-model.pt'
